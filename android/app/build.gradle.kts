...
fun prop(name: String, default: String = "") =
    (localProps.getProperty(name) ?: default).replace("\"", "\\\"")

android {
    namespace = "com.aegisai.app"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.aegisai.app"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"

        buildConfigField("String", "API_BASE_URL", "\"${prop("API_BASE_URL", "https://aegis-ai-xxg2.onrender.com")}\"")
